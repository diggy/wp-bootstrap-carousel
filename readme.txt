...
As a bonus, this plugin can transform post listings generated by the [Display Posts Shortcode](https://wordpress.org/plugins/display-posts-shortcode/) plugin (version 2.2.1 or higher) into a Bootstrap Carousel slideshow.
...
Bugs related to the WP Bootstrap Carousel plugin can be reported on the [WordPress support forums](https://wordpress.org/support/plugin/wp-bootstrap-carousel) or, preferably, on [GitHub](https://github.com/diggy/wp-bootstrap-carousel).
