...
class WP_Bootstrap_Carousel
{
     ...
     * @since   0.2.0
     * @access  public
     * @uses    WP_Bootstrap_Carousel::plugin_path()
     * @return  void
     */
    public function i18n()
    {
        // load localization files
        load_plugin_textdomain( 'wp_bootstrap_carousel', false, $this->plugin_path() . '/lang/' );
    }
    /**
    ...
    public function shortcode( $atts )
    {
        ...
        $carousel .= '<div id="wp-bootstrap-carousel-' . $post_parent . '" class="carousel' . ( ( $slide ) ? " slide" : "" ) . '" style="width:100%;' . $max_width . '" data-interval="' . $interval . '" data-pause="' . $pause . '" data-wrap="' . $wrap . '">';
        ...
        if( $controls ) {
            $carousel .= '
  <a class="carousel-control left" href="#wp-bootstrap-carousel-' . $post_parent . '" role="button" data-slide="prev"><span class="icon-prev"></span></a>
  <a class="carousel-control right" href="#wp-bootstrap-carousel-' . $post_parent . '" role="button" data-slide="next"><span class="icon-next"></span></a>';
        }
    ...
    public function get_data( $atts )
    {
        ...
        // return data
        return compact( 'query', 'post_parent', 'width', 'image_size', 'rel', 'file', 'comments', 'slide', 'controls', 'interval', 'pause', 'wrap', 'thickbox', 'unwrap' );
    }
    /**
     * Enqueue scripts.
     *
    ...
    public function wp_enqueue_scripts()
    {
        ...
        wp_register_script( 'wp-bootstrap-carousel',        $this->plugin_url() . '/js/carousel' . $min . '.js', array( 'jquery' ), '3.2.0', true );
